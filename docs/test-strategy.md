...
- [OpenAI Evals](https://github.com/openai/evals) — open-source eval framework and examples
- [Anthropic's approach to evaluations](https://www.anthropic.com/research) — model cards describe eval methodology
...
- See also: [`docs/eval.md`](./eval.md) for implementation details specific to this project
